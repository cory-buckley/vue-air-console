...
;
window.xmlHttpRequestRetryRanger={CHUNK_SIZE:8388608,MATCH:function(a){return 0==a.indexOf("Build/")&&a.endsWith(".unityweb")||-1!=a.indexOf("StreamingAssets/")&&a.endsWith(".unity3d")||0==a.indexOf("Release/")&&(a.endsWith(".js")||a.endsWith(".jsgz")||a.endsWith(".mem")||a.endsWith(".memgz")||a.endsWith(".data")||a.endsWith(".datagz"))},ACTIVE:function(){if((window.onGameReady||window.UnityLoader)&&"game.airconsole.com"==document.location.hostname&&document.location.pathname.endsWith("screen.html")&&
window.app&&!window.app.is_unity_ready){var a=["Chrome","Safari","Firefox","Edge"];if(navigator.userAgent)for(var b=0;b<a.length;++b)if(-1!=navigator.userAgent.indexOf(a[b]+"/"))return!0}return!1},USE_PSEUDO_RANGE_HEADERS:!0,URL_REWRITE:function(a,b,e,c){c=a.split("#");var d=c[0];a=void 0;void 0!=c[1]&&(c.shift(),a=c.join("#"));d=-1==d.indexOf("?")?d+"?":d+"&";b=d+("xmlhttprequest-ranger-start="+b+"&xmlhttprequest-ranger-end="+e);void 0!=a&&(b+="#"+a);return b}};
;
